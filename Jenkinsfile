...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.41.63:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-moustafa', //update and provide your channel name
